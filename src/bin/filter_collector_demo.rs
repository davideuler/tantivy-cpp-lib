...
use tantivy::fastfield::{FastValue, Column};
    ...
    TPredicate: Fn(TPredicateValue) -> bool + Send + Sync + Clone,
{
    ...
    pub fn new(
        ...
        // for struct of generic types, param position does not matter in struct intitialization
        FilterCollector {
            field,
            collector,
            predicate,
    ...
    TPredicateValue: FastValue,
{
    ...
    ) -> tantivy::Result<FilterSegmentCollector<TCollector::Child, TPredicate, TPredicateValue>> {
